...
const About = () => {
  return (
    <section id="about" className="p-16 bg-yellow-700 h-auto">
      <div className="bg-white p-6 rounded-lg shadow-md h-auto md:h-96 lg:h-full">
        <h2 className="text-3xl font-bold mb-6 text-center">About Our Church</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-yellow-100 p-4 rounded-lg shadow border-2 border-gray-600">
            ...
            <p>St Augustine Catholic Church has served the Juja community for over 50 years, with a legacy of faith, service, and community.</p>
          </div>
          <div className="bg-yellow-100 p-4 rounded-lg shadow border-2 border-gray-600">
