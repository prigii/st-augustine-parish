    ...
    <nav className="bg-yellow-500 shadow-md p-4 w-full flex">
      <div className="container mx-auto flex items-center justify-between">
        <div className="flex items-center">
          ...
          <div className="text-xl text-black font-bold leading-tight sm:text-2xl sm:leading-tight">
            <NavLink to={'/'}>St. Augustine Catholic Parish &<br />University Chaplaincy, Juja</NavLink>
          </div>
        </div>
        <div>
